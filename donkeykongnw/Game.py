            ...
            if self.newGame.gameState == 1:
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == KEYDOWN:
                        ...
                        if (event.key == K_SPACE and not self.newGame.Players[0].onLadder ) or (
                                event.key == K_UP and self.laddersCollidedExact):
                ...
                if keyState[pygame.K_UP] and self.newGame.Players[0].onLadder:
                ...
                if keyState[pygame.K_DOWN] and self.newGame.Players[0].onLadder:
                    self.newGame.Players[0].updateWH(pygame.image.load('Assets/still.png'), "V",
                                                     self.newGame.Players[0].getSpeed() / 2, 15, 15)
